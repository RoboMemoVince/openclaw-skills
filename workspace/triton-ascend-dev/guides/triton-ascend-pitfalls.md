...
Triton-Ascend supports FP8 types (`float8e5`, `float8e4b15`, etc.) but with limitations:

- Conversion via `tl.fp_to_fp()` function
- Not all operations support FP8 directly
- May require explicit casting for some operations
