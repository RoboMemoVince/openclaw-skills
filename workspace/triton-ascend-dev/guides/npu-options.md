...
NPUOptions is defined in `third_party/ascend/backend/compiler.py:665` and controls how kernels are compiled for Ascend NPU.
...
- NPUOptions definition: `third_party/ascend/backend/compiler.py:665`
- Option parsing: `third_party/ascend/backend/compiler.py:841` (`parse_options`)
- BiSheng option mapping: `third_party/ascend/backend/compiler.py:354` (`get_common_bishengir_compile_options`)
